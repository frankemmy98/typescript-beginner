...
// Type Alias
// it is restricted, we can extend the type 
// but it will require adding all the properties
...
// Unknown Type
// if you dont know what type its going to be.

// let personName: unknown

// Never Type
// if you dont know what type its going to return.

// let printName: (name: string) => never


// N.B: Void returns undefined but Never returns nothing.